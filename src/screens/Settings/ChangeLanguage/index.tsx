...
const ChangeLanguage = (props: SuccessPopProps) => {
      ...
      <Animated.View style={styles.container}>
        ...
        <View style={{marginHorizontal: moderateScale(24)}}>
          <View
            ...
            <FillCircle />
            <Text style={{marginHorizontal: moderateScale(8)}}>English</Text>
          </View>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            <EmptyCircle />

            <Text style={{marginHorizontal: moderateScale(8)}}>العربيه</Text>
          </View>
